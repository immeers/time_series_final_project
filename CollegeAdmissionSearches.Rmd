...
```{r}
model_names <- c("SNAIVE", "SES", "TSLM", "ARIMA", "MA TRAILING", "MA CENTERED", "NNAR", "ETS", "WAVE")
...
for (i in (1:length(file_paths))){
  ...
  mape_values <- c(snaive_mape, ses_mape, tslm_mape, arima_mape, ma_trailing_mape, ma_centered_mape, nnar_mape, ets_mape, wave_mape)
