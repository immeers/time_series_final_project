...
For each school, we will perform the following process.
  ...
  1. Determine the best time time series for the data.
...
#### (6) ETS/STLF
For a frequency higher than 24, it is recommended to use Seasonal and Trend Decomposition with Loess (STLF), which implicity uses an ETS model.
```{r}
ets_models = list()
